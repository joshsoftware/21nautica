...
DESTINATION_PORTS = %W(Nhava\ Sheva Mundra Tuticorin Chennai Jebel\ Ali Mersin Sydney)
TYPE = %W(TBL Haulage)
CURRENCY = %w(USD UGX)
EQUIPMENT_TYPE = %W(20GP 40GP 40OT 40FR 20OT)
ROLE = %W(Admin Staff)
SALES_REP_NAMES = ['Kaushik', 'Rajan'] 
EMAILS_DEFAULTS = 'accounts@21nautica.com, kaushik@21nautica.com, docs@21nautica.com, docs-ug@21nautica.com, ops-ug@21nautica.com, chetan@21nautica.com, ops@21nautica.com, Sales-ug@21nautica.com ' 
...
PORTS = {"Dar Es Salaam" => ["Kigali", "Lusaka", "Goma"], "Mombasa" => ["Kampala"]}
